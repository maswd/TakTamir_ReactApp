        ...
        <div id="features">
            <section className="featuresfour-wrapper featuresfour__section forPadding">
                <div className="featuresfour-texts">
                    <div className="featuresfour-texts__title" >ویژگی‌ها و ارزش‌های ما</div>
                    <div className="featuresfour-texts__desc right" >هزینه و زمان زیادی برای ساخت لندینگ پیج ( صفحه فرود
                        ) توسط تیم محصول صرف می کنید. همین حالا اقدام کنید</div>
                </div>
                <div className="row justify-content-center align-items-center featuresfour-row featuresfour-position-right">
                    <div className="col-md-12 col-lg-6 featuresfour-items">
                        <div className="featuresfour-item">
                            <div className="featuresfour-item__img"><svg xmlns="http://www.w3.org/2000/svg" width="41.259"
                                height="48.02" viewBox="0 0 41.259 48.02">
                                <g id="jump-v1" transform="translate(-976.221 -403.68)">
                                    ...
                                    <path id="Path_29" data-name="Path 29" className="section-icon"
                                        d="M978.516,438.214a1.5,1.5,0,0,0,1.118-.5l4.036-4.505a1.5,1.5,0,1,0-2.234-2l-4.037,4.505a1.5,1.5,0,0,0,1.117,2.5Z">
                                    </path>
                                    <path id="Path_30" data-name="Path 30" className="section-icon"
                            ...
                            <div className="featuresfour-item__texts">
                                <div className="featuresfour-item__title" >امکان پرداخت درب محل</div>
                                <div className="featuresfour-item__desc right" >لورم ایپسوم متن ساختگی با تولید سادگی
                                    نامفهوم از صنعت چاپ و با استفاده از طراحان گرافیک است. چاپگرها و متون بلکه روزنامه و
                                    مجله در ستون و سطرآنچنان که لازم است و برای شرایط فعلی تکنولوژی .</div>
                            </div>
                        </div>
                        <div className="featuresfour-item">
                            <div className="featuresfour-item__img"><svg xmlns="http://www.w3.org/2000/svg" width="43.129"
                                height="50.055" viewBox="0 0 43.129 50.055">
                                <g id="pin-v1" transform="translate(-287.309 -230.248)">
                                    <path id="Path_8" data-name="Path 8" className="section-icon"
                        ...
                        <div className="featuresfour-item">
                            ...
                            <div className="featuresfour-item__texts">
                                <div className="featuresfour-item__title" >امکان چاپ نام و شماره دلخواه</div>
                                <div className="featuresfour-item__desc right" >لورم ایپسوم متن ساختگی با تولید سادگی
                                    نامفهوم از صنعت چاپ و با استفاده از طراحان گرافیک است. چاپگرها و متون بلکه روزنامه و
                                    مجله در ستون و سطرآنچنان که لازم است و برای شرایط فعلی تکنولوژی .</div>
                            </div>
                    ...
                    <div className="col-md-12 col-lg-6 featuresfour-img">
                        <div className="featuresfour-img__wrapper"><img src={ten} /></div>
                    </div>
                </div>
            </section>
        </div>
