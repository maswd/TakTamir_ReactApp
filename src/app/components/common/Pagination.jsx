...
const Pagination = ({ totalItems ,onPageChange}) => {
  ...
  return (
    <ul className="mt-2 mb-3 pagination shadow-sm justify-content-center" style={{ direction: "ltr" }}>
      <li className="paginate_button text-center w-100 page-item previous disabled" id="dataTable_previous">
        <button type="button" aria-controls="dataTable" data-dt-idx="0" tabIndex="0" className="page-link w-100">
          برگشت
        </button>
      </li>
      {renderPageLinks()}
      <li className="w-100 text-center paginate_button page-item next" id="dataTable_next">
        <button type="button" aria-controls="dataTable" data-dt-idx="7" tabIndex="0" className="page-link w-100">
          بعدی
        </button>
      </li>
    </ul>
