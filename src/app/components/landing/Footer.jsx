                    ...
                    <div className="tem2-info">
                      ...
                      <div className="tem2-desc color-links">
                        <p style={{ direction: "rtl", textAlign: "right" }}>
                            تک تعمیر، ارائه دهنده بهترین خدمات تعمیر
                          لوازم خانگی در منزل است. تیم مجرب و حرفه‌ای ما با
                          نظارت کامل در منزل شما، تعمیرات لوازم خانگی را با
                          کیفیت بالا و با استفاده از قطعات با کیفیت انجام
                          می‌دهند. با استفاده از خدمات ما، شما می‌توانید از
                          تعمیرات مکرر و هزینه‌های اضافی جلوگیری کنید و از کیفیت
                          قطعات استفاده شده مطمئن شوید.
                        </p>
                      </div>
                    </div>
                  </div>
                          ...
                          <div className="tem2-data">
                            <ul>
                              <li>
                                ...
                                <p>
                                  تهران، خیابان انقلاب، نرسیده به چهارراه ولی
                                  عصر، کوچه بالاور، پلاک ۷، برج فناوری دانشگاه
                                  صنعتی امیرکبیر، طبقه دوم، فینووا
                                </p>
                              </li>
                              ...
                              <li>
                                <img src={email2} alt="" />
                                <Link
                                  href="mailto:hi@landin.ir"
                                  className="tem2-email"
                                >
                                  taktamir.ir
                                </Link>
                              </li>
