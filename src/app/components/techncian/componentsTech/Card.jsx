        ...
        <div className="card-body">
          ...
          <div className="row no-gutters align-items-center">
            <div className="col ml-2">
              ...
              {props.jobsOrder[0].statusJob === "Completed" && (
                <div className="pt-2 d-flex g-3 font-weight-bold text-gray-800">
                  ...
                  <div className="d-flex justify-content-evenly w-100">
                    <div className="text-gray-900 small">
                      کل هزینه دریافتی{" "}
                      <div className="text-center">{ToRial(props.total)}</div>
                    </div>
                    <div className="text-gray-900 small">
                      جمع خرج کرد{" "}
                      <div className="text-center">{ToRial(props.spent)}</div>
                    </div>
                  </div>
                </div>
              )}
            ...
            <div className="col-auto text-left">
              {props.jobsOrder[0].statusJob !== "Completed" &&
                props.jobsOrder[0].statusJob !== "waiting" &&
                props.jobsOrder[0].statusJob !== "Cancel" && (
                  <StatusDropdown
                    id={props.id}
