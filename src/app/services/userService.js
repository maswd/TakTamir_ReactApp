...
export const checkPhone = phone => {
  return http.get(`${config.api}/api/AuthUsers/signup_phone_number?phone_number=${phone}`)
}
...
export const registerUser = (user) => {
  return http.put(`${config.api}/api/Users/Update_user`, user)
}
...
export const getProfile = (token) => {
  return http.get(`${config.api}/v1user/me`, token)
}
